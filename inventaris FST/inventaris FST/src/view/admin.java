...
import TableMod.TableMod_Admin;
...
public class admin extends javax.swing.JPanel {
    ...
    TableMod_Admin tblMod = new TableMod_Admin();
...
//        btn_search.requestFocus();
    ...
    private void initComponents() {
        ...
        lb_nama4 = new javax.swing.JLabel();
        ...
        judul2.setText("Tambah Data Admin");
        ...
        jPanel1.add(tf_kode, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 72, 896, 32));

        lb_kode.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 18)); // NOI18N
        lb_kode.setText("ID Admin");
        jPanel1.add(lb_kode, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 33, 126, 27));

        lb_nama.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 18)); // NOI18N
        lb_nama.setText("Nama Admin");
        jPanel1.add(lb_nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 116, 126, 27));

        tf_nama.setFont(new java.awt.Font("Leelawadee UI", 0, 14)); // NOI18N
        jPanel1.add(tf_nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 155, 896, 32));

        lb_nama1.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 18)); // NOI18N
        lb_nama1.setText("No.tlp");
        jPanel1.add(lb_nama1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 199, 126, 27));
        ...
        jPanel1.add(tf_telp, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 238, 896, 32));

        lb_nama2.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 18)); // NOI18N
        lb_nama2.setText("Email");
        jPanel1.add(lb_nama2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 282, 126, 27));

        tf_email.setFont(new java.awt.Font("Leelawadee UI", 0, 14)); // NOI18N
        jPanel1.add(tf_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 321, 896, 32));

        t_user.setFont(new java.awt.Font("Leelawadee UI", 0, 14)); // NOI18N
        jPanel1.add(t_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 404, 392, 31));

        lb_nama3.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 18)); // NOI18N
        lb_nama3.setText("Buat username :");
        jPanel1.add(lb_nama3, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 365, 223, 27));

        lb_nama4.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 18)); // NOI18N
        lb_nama4.setText("Buat password :");
        jPanel1.add(lb_nama4, new org.netbeans.lib.awtextra.AbsoluteConstraints(445, 365, 223, 27));
        ...
        jPanel1.add(lb_showPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 410, -1, -1));
        ...
        jPanel1.add(lb_hidePassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 410, -1, -1));

        tf_pass.setFont(new java.awt.Font("Leelawadee UI", 0, 14)); // NOI18N
        jPanel1.add(tf_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(445, 404, 347, 31));
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        if (x.equals("TAMBAH")) {
            ...
            if (index != -1) {
                Model_Admin mod = tblMod.getData(tbl_data.convertRowIndexToModel(index));
    ...
    private javax.swing.JLabel lb_nama4;
    ...
    private void loadData() {
        ...
        List<Model_Admin> list = servis.getData();
        tblMod.setData(list);
    ...
    private void dataTabel() {
        ...
        int row = tbl_data.getSelectedRow();
        judul2.setText("Perbarui Data Admin");
    ...
    private void hapusData() {
        int index = tbl_data.getSelectedRow();
        if(index!=-1){
            Model_Admin brg = tblMod.getData(tbl_data.convertRowIndexToModel(index));
    ...
    }else if (t_user.getText().trim().isEmpty()){
    ...
    private void simpanData() {
        if(validasiInput()==true){
            ...
            mod.setTelp_admin(telp);
            mod.setEmail_admin(email);
    ...
    private void perbaruiData() {
        ...
        if (index != -1) {
            ...
            if (validasiInput() == true) {
                ...
                Model_Admin s = new Model_Admin();

                s.setId_admin(kode);
                s.setNama_admin(nama);
                s.setTelp_admin(telp);
                s.setEmail_admin(email);
                s.setUsername(user);
                s.setPassword(pass);
    ...
    private void pencarian() {
       List<Model_Admin> list = servis.pencarian(tf_pencarian.getText().toLowerCase());
        tblMod.setData(list);
    }
