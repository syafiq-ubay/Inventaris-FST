...
import TableMod.TableMod_Pemesan;
import dao.DAO_pemesan;
...
public class pemesan extends javax.swing.JPanel {
    ...
    private Service_Pemesan servis = new DAO_pemesan();
    TableMod_Pemesan tblMod = new TableMod_Pemesan();
...
//        btn_search.requestFocus();
    ...
    private void initComponents() {
        ...
        lb_nama1.setText("Unit");

        tf_unit.setFont(new java.awt.Font("Leelawadee UI", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tf_unit, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void loadData() {
        ...
        List<Model_Pemesan> list = servis.getData();
        tblMod.setData(list);
    ...
    private void hapusData() {
        int index = tbl_data.getSelectedRow();
        if(index!=-1){
            Model_Pemesan brg = tblMod.getData(tbl_data.convertRowIndexToModel(index));
    ...
    }else if (tf_unit.getText().trim().isEmpty()){
    ...
    private void simpanData() {
        if(validasiInput()==true){
            ...
            mod.setId_pemesan(kode);
            mod.setNama_pemesan(nama);
            mod.setUnit_pemesan(unit);
    ...
    private void perbaruiData() {
        ...
        if (index != -1) {
            ...
            if (validasiInput() == true) {
                ...
                servis.perbaruiData(modi);
                tblMod.perbaruiData(index, modi);
                loadData();
                resetForm();
                tampilPanel();
    ...
    private void pencarian() {
       List<Model_Pemesan> list = servis.pencarian(tf_pencarian.getText().toLowerCase());
        tblMod.setData(list);
    }
